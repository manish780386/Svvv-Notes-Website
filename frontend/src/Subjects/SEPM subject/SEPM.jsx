  ...
  return (
    <div className="wrapper">
      ...
      <div className="header">
        <h1> Software Engineering and Project Management(SEPM)</h1>
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/notes/sepm/notes">View Notes</Link></button>
        </div>
