...
export default function ComputerSystemOrganization() {
  ...
  return (
    <div className="wrapper">
      ...
      <div className="header">
        <h1> Computer System Organization(CSO)</h1>
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/CSO/CSOnotes">View Notes</Link></button>
        </div>
