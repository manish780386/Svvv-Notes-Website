    ...
    <div className="wrapper">
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/notes/operating system/notes">View Notes</Link></button>
        </div>
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/OS/OSpyqs">View PYQs</Link></button>
        </div>
