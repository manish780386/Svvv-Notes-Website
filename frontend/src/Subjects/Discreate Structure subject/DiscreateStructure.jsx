...
export default function DiscreateStructure() {
    ...
    <div className="wrapper">
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/notes/discreate structure/notes">View Notes</Link></button>
        </div>
