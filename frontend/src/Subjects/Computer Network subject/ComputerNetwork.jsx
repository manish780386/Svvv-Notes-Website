    ...
    <div className="wrapper">
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/notes/computer network/notes">View Notes</Link></button>
        </div>
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/CN/CNpyqs">View PYQs</Link></button>
        </div>
