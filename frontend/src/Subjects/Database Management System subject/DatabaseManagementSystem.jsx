...
export default function DatabaseManagementSystem() {
    ...
    <div className="wrapper">
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/notes/database management system/notes">View Notes</Link></button>
        </div>
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/DBMS/DBMSpyqs">View PYQs</Link></button>
        </div>
