...
export default function AnalysisandDesignAlgorithms() {
  ...
  return (
    <div className="wrapper">
      ...
      <div className="header">
        <h1> Analysis and Design of Algorithms(ADA)</h1>
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/ADA/ADAnotes">View Notes</Link></button>
        </div>
