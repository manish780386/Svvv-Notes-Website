...
export default function ObjectOrientendAnalysisandDesign() {
  ...
  return (
    <div className="wrapper">
      ...
      <div className="header">
        <h1> Object Orientend Analysis and Design</h1>
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="*">View Notes</Link></button>
        </div>
