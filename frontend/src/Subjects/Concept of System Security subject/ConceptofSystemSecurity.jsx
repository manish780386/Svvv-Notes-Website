...
export default function ConceptofSystemSecurity() {
  ...
  return (
    <div className="wrapper">
      ...
      <div className="header">
        <h1> Concept of System Security</h1>
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/CSS/CSSnotes">View Notes</Link></button>
        </div>
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/CSS/CSSpyqs">View PYQs</Link></button>
        </div>
