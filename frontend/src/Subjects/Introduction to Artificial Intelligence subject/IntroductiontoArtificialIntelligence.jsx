...
export default function IntroductiontoArtificialIntelligence() {
    ...
    <div className="wrapper">
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/notes/introduction to artificial intelligence/notes">View Notes</Link></button>
        </div>
