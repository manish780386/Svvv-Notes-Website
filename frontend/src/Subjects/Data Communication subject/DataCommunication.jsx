    ...
    <div className="wrapper">
      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/notes/data communication/notes">View Notes</Link></button>
        </div>
        ...
        <div className="card">
          ...
          <button className="action-btn"><Link to="/DC/DSpyqs">View PYQs</Link></button>
        </div>
